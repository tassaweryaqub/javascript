// functie voor invoernaam op scherm

function toonPrompt(){
  var code = prompt('Voer uw gamenaam in', 'uw gamenaam');
  var naam = 'Uw gamenaam is:'+ code; 
  document.getElementById('divResult').innerHTML= naam; 
